...
def ingest():
    ...
    #         metadata={
    #             "source": "D:\\Code\\langchainjs-test\\assets\\Brillar Bank _ Junior Fixed Deposit.pdf",
    #         },
    #     ),
    #     Document(
    ...
    #         metadata={
    #             "source": "D:\\Code\\langchainjs-test\\assets\\Brillar Bank_Fixed Deposit.pdf",
    #         },
    #     ),
    #     Document(
    ...
    #         metadata={
    #             "source": "D:\\Code\\langchainjs-test\\assets\\Brillar Bank_Flexi Fixed Deposit.pdf",
    #         },
    #     ),
    #     Document(
    ...
    #     #     metadata={
    #     #         "source": "D:\\Code\\langchainjs-test\\assets\\Brillar Bank_Senior Savers Flexi Fixed Deposits.pdf",
    #     #     },
    #     # ),
    #     # Document(
    ...
    #         + "foreign currency",
    #         metadata={
    #             "source": "D:\\Code\\langchainjs-test\\assets\\Brillar Bank_Types of Fixed Deposit.pdf",
    #         },
    #     ),
    # ]
    ...
    result = ingest_data(
        ...
        index_name="adaptive_rag_test_3",
        vector_db="chromadb",
        dimension=256,
    )
